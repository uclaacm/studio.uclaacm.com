...
export function createGetStaticProps({ category }: CreateGetStaticPropsParams): GetStaticProps<ArticleProps> {
	return async (ctx) => {
...
export function createGetStaticPaths({ category }: CreateGetStaticPathsParams): GetStaticPaths {
	return async (ctx) => {
