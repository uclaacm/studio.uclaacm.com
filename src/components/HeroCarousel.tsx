...
const HeroCarousel: React.FC<HeroCarouselProps> = ({images, interval = 3000}) => {
    ...
    return (
        <LayoutGroup>
            ...
            >
                <ChevronLeft style={{ width: "1em", height: "1em" }} fill={theme.palette.primary.main}/>
            </IconButton>
            <IconButton onClick={() => nextPage(1)}
                variant="outlined"
                sx={{
            ...
            >
                <ChevronRight style={{ width: "1em", height: "1em" }} fill={theme.palette.primary.main}/>
            </IconButton>
        </LayoutGroup>  
    );
}
