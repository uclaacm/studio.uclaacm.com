  ...
  return (
    <>
      <Head>
        ...
        <meta content="ACM Studio | Home" property="og:title" />
        <meta
          content="ACM Studio at UCLA is a committee focused upon creating a community for students interested in any aspect of game development."
          property="og:description"
        />
        <meta content="ACM Studio" property="og:site_name" />
        <meta
          content="../assets/images/studio_motif_base.png"
          property="og:image"
        />
      </Head>
