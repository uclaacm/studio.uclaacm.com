...
export default function TryGameJams(props: TryGameJamsProps) {
	...
	async function animationSequence(){
		...
		animate(".try-game-jams__bullet", {
			"--animation-percent": 1,
		}, {
			delay: stagger(
				theme.transitions.duration.short / 1000,
	...
	>
		<Box>
			<Box className="try-game-jams__header"
				sx={{
					display: "grid",
					width: "100%",
			...
			>
				...
				<Box width="fit-content" sx={{ gridColumn: 2 }}>
					<Typography variant="display2" component="span" className="try-game-jams__header-section try-game-jams__commitment-issues"
						display="block"
						sx={
							[
								animationStyle(),
					...
					<Typography component="span" variant="display1" className="try-game-jams__header-section"
						display="block"
						sx={animationStyle()}
					>
						Try game jams.
