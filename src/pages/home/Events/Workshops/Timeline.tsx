  ...
  return (
    <g>
      ...
      <motion.rect
        ...
        y={rectY}
        width={taskRectWidth}
        height={taskRectHeight}
        rx="24"
        stroke="#FF4466"
        strokeWidth={taskRectStrokeWidth}
        variants={scaleVariants}
      />
...
export default function Timeline(props: TimelineProps) {
  let { nDots = 3, controlsRef: animateRef, tasks, ...rest } = props;
    ...
    >
      ...
      <g>
        {Array.from({ length: nDots + 1 }).map((_, i, arr) =>
          i !== arr.length - 1 ? (
            <motion.g variants={scaleVariants} key={i}>
              <circle
                key={i}
                cx={lastRectX + 16 + 32 * i}
                cy="225"
                r="8"
                fill="#FF4466"
              />
            ...
            <motion.g key={i} variants={scaleVariants}>
              <path
                transform={`translate(${lastRectX + 16 + 32 * i - 8} ${228 - 16})`}
                key={i}
                d="M0 19.9237C0 23.2338 3.79117 25.1115 6.42417 23.1054L16.824 15.1817C18.9251 13.5809 18.9251 10.4191 16.824 8.81827L6.42417 0.894608C3.79117 -1.11149 0 0.766179 0 4.07634V19.9237Z"
                fill="#FF4466"
              />
            </motion.g>
          ),
