      ...
      >
        <Box
          sx={{
            ...
            display: "grid",
            gridTemplateColumns: "2fr minmax(4rem,1fr)",
          }}
        >
          <Box
            sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            <BoldTypographyItem>support</BoldTypographyItem> students interested
            in <UnderlineTypographyItem>all aspects</UnderlineTypographyItem> of
            game development...
          </Typography>
        </Box>
      </Container>
